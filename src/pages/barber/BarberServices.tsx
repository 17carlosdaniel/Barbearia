...
const BarberServices = () => {
  ...
  const wizardCopy = isModern
    ? {
        ...
        steps: ["Básico", "Apresentação", "Operação"] as const,
        sectionBasic: "Informações básicas",
        sectionShowcase: "Apresentação do serviço",
        sectionOperation: "Operação e disponibilidade",
        nameLabel: "Nome do corte",
        categoryLabel: "Categoria",
        durationLabel: "Duração (min)",
        priceLabel: "Preço (R$)",
        durationHint: "Dica: corte masculino ~30 min, barba ~20 min, coloração ~90 min.",
        descriptionLabel: "Descrição do corte",
        descriptionPlaceholder: "Descreva o serviço: o que inclui, duração, estilo...",
        imageLabel: "Imagem do serviço",
        imageButtonAdd: "Enviar foto",
        imageButtonReplace: "Trocar foto",
        imageHelp: "Opcional. Adicione uma imagem para ilustrar o serviço no app.",
        previewTitle: "Prévia do cliente",
        previewFallback: "Descrição curta que ajuda na decisão.",
        assigneeLabel: "Quem executa esse serviço",
        activeTitle: "Serviço ativo",
        activeDesc: "Visível para agendamento dos clientes",
        extrasTitle: "Ferramentas extras (opcional)",
        extraGenerate: "Gerar descrição",
        extraOffer: "Criar promoção",
      }
    : {
        subtitleNew: "Defina os detalhes do serviço para apresentação e agendamento.",
        subtitleEdit: "Refine os detalhes do serviço para apresentação e agendamento.",
        steps: ["Essencial", "Vitrine", "Atendimento"] as const,
        sectionBasic: "Essencial do serviço",
        sectionShowcase: "Como o cliente vê",
        sectionOperation: "Atendimento e disponibilidade",
        nameLabel: "Nome do serviço",
        categoryLabel: "Categoria do serviço",
        durationLabel: "Tempo do atendimento (min)",
        priceLabel: "Valor do serviço (R$)",
        durationHint: "Referência: corte masculino ~30 min, barba ~20 min, coloração ~90 min.",
        ...
        imageButtonReplace: "Trocar foto",
        imageHelp: "Opcional. Uma boa imagem valoriza a apresentação do serviço.",
        previewTitle: "Como aparece para o cliente",
        previewFallback: "Uma descrição que valoriza o atendimento e a experiência.",
        assigneeLabel: "Quem realiza este serviço",
        activeTitle: "Serviço disponível",
        activeDesc: "Exibido para agendamento dos clientes",
        extrasTitle: "Recursos extras (opcional)",
        extraGenerate: "Sugerir descrição",
            ...
            {formStep === 2 && (
              ...
              >
                ...
                <div className={cn("rounded-lg p-3", isModern ? "border border-primary/30 bg-primary/5" : "border border-primary/35 bg-primary/8 shadow-[inset_0_1px_0_hsl(var(--primary-foreground)/0.08)]")}>
                  ...
                  <p className="font-semibold text-foreground">{newName || "Nome do serviço"}</p>
